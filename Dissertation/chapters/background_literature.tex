...
Further to understanding the foundational concepts of transactions as seen above, we need to understand the underlying concepts of transaction verification. The algorithm used to verify blockchain transactions is known as asymmetric encryption \autocite{champagneBookSatoshiCollected2014}. 
