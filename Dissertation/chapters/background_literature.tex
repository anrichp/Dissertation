...
\subsubsection{Property 2: Hiding}
...
\subsubsection{Property 3: Puzzle Friendliness}

A puzzle-friendly hash function is difficult to solve using a strategy, rather the puzzle is solved through brute force. To define a puzzle we use the expression \(H(id || x) \epsilon Y \)
